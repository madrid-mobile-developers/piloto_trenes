...
exports['file.expand*'] = {
  ...
  'basic matching': function(test) {
    ...
    test.deepEqual(grunt.file.expand('**/*.js', '**/*.css'), ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'should match.');
    test.deepEqual(grunt.file.expand(['**/*.js', '**/*.css']), ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'should match.');
  ...
  'unique': function(test) {
    ...
    test.deepEqual(grunt.file.expand('**/*.js', '**/*.css', 'js/*.js'), ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'file list should be uniqed.');
  ...
  'file order': function(test) {
    test.expect(4);
    var actual = grunt.file.expand('**/*.{js,jquery.mobile}');
    var expected = ['jquery.mobile/baz.css', 'jquery.mobile/qux.css', 'js/bar.js', 'js/foo.js'];
    test.deepEqual(actual, expected, 'should select 4 files in this order, by default.');

    actual = grunt.file.expand('js/foo.js', 'js/bar.js', '**/*.{js,jquery.mobile}');
    expected = ['js/foo.js', 'js/bar.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = grunt.file.expand('js/bar.js', 'js/foo.js', '**/*.{js,jquery.mobile}');
    expected = ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = grunt.file.expand('js/foo.js', '**/*.{js,jquery.mobile}', '!js/bar.js', 'js/bar.js');
    expected = ['js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css', 'js/bar.js'];
    test.deepEqual(actual, expected, 'if a file is excluded and then re-added, it should be added at the end.');
    test.done();
  },
  'flatten': function(test) {
    test.expect(1);
    test.deepEqual(grunt.file.expand([['**/*.js'], ['**/*.css', 'js/*.js']]), ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'should match.');
    test.done();
  },
  'exclusion': function(test) {
    test.expect(8);
    ...
    test.deepEqual(grunt.file.expand(['**/*.js', '**/*.css', '!js/bar.js', '!jquery.mobile/baz.css']), ['js/foo.js','jquery.mobile/qux.css'], 'multiple exclusions should be removed from the set');
    ...
    test.deepEqual(grunt.file.expand(['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css', '!**/b*.*']), ['js/foo.js', 'jquery.mobile/qux.css'], 'different pattern for exclusion should still work');
    test.deepEqual(grunt.file.expand(['js/bar.js', '!**/b*.*', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css']), ['js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'inclusion / exclusion order matters');
    test.done();
  },
  'options.matchBase': function(test) {
    test.expect(4);
    ...
    test.deepEqual(grunt.file.expand(opts, '*.js', '*.css'), ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'should match.');
    test.deepEqual(grunt.file.expand(opts, ['*.js', '*.css']), ['js/bar.js', 'js/foo.js', 'jquery.mobile/baz.css', 'jquery.mobile/qux.css'], 'should match.');
    test.done();
  },
...
exports['file.expandMapping'] = {
  ...
  'rename to same dest': function(test) {
    ...
    var expected = [
      ...
      {dest: 'dest/all.css', src: ['expand/jquery.mobile/baz.css', 'expand/jquery.mobile/qux.css']},
...
exports['file'] = {
  ...
  'recurse': function(test) {
    ...
    var expected = {};
    expected[rootdir + '/jquery.mobile/baz.css'] = [rootdir, 'css', 'baz.css'];
    expected[rootdir + '/jquery.mobile/qux.css'] = [rootdir, 'css', 'qux.css'];
