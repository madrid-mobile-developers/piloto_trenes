...
module.exports = {
  ...
  /**
   * Transform sass to jquery.mobile, wrapped in style tags.
   */
  
  sass: function(str){
    str = str.replace(/\\n/g, '\n');
    var sass = require('sass').render(str).replace(/\n/g, '\\n');
    return '<style type="text/jquery.mobile">' + sass + '</style>';
  },
  
  /**
   * Transform stylus to jquery.mobile, wrapped in style tags.
   */
  ...
  stylus: function(str, options){
    ...
    return '<style type="text/jquery.mobile">' + ret + '</style>';
  },
  
  /**
   * Transform less to jquery.mobile, wrapped in style tags.
   */
  ...
  less: function(str){
    ...
    require('less').render(str, function(err, css){
      if (err) throw err;
      ret = '<style type="text/jquery.mobile">' + css.replace(/\n/g, '\\n') + '</style>';
    });
    return ret;
  },
