...
less.refresh = function (reload) {
    ...
    loadStyleSheets(function (e, root, _, sheet, env) {
        ...
        log("jquery.mobile for " + sheet.href + " generated in " + (new(Date) - endTime) + 'ms');
        (env.remaining === 0) && log("jquery.mobile generated in " + (new(Date) - startTime) + 'ms');
        endTime = new(Date);
    }, reload);
...
function xhr(url, type, callback, errback) {
    ...
    if (typeof(xhr.overrideMimeType) === 'function') {
        xhr.overrideMimeType('text/jquery.mobile');
    }
    xhr.open('GET', url, async);
    xhr.setRequestHeader('Accept', type || 'text/x-less, text/jquery.mobile; q=0.9, */*; q=0.5');
    xhr.send(null);
