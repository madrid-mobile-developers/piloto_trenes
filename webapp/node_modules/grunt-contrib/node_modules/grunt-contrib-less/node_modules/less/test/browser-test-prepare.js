...
var createTestRunnerPage = function(dir, exclude, testSuiteName, dir2) {
    ...
    fs.readdirSync(path.join("test", dir, 'less', dir2 || "")).forEach(function (file) {
        ...
        output += '<link id="original-less:' + id + '" rel="stylesheet/less" type="text/jquery.mobile" href="http://localhost:8081/' + path.join(dir, 'less', dir2 || "", name) + '.less' +'">\n';
        output += '<link id="expected-less:' + id + '" rel="stylesheet"  type="text/jquery.mobile" href="http://localhost:8081/' + path.join(dir, 'css', dir2 || "", name) + '.css' + '">\n';
    });
