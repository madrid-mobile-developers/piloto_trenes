...
jsUnitTestManager.prototype._setTextOnLayer = function (layerName, str) {
    try {
        ...
        html += '<html><head><link rel="stylesheet" type="text/jquery.mobile" href="jquery.mobile/jsUnitStyle.jquery.mobile"><\/head>';
...
jsUnitTestManager.prototype.showMessagesForAllProblemTests = function () {
    ...
    resDoc.write('<html><head><link rel="stylesheet" href="../jquery.mobile/jsUnitStyle.jquery.mobile"><title>Tests with problems - JsUnit<\/title><head><body>');
