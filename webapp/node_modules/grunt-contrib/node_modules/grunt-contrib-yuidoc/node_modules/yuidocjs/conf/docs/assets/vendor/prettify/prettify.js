 ...
 *    some jquery.mobile styles may not be preserved.
 * </ol>
...
(function () {
  ...
  // token style names.  correspond to jquery.mobile classes
  /**
  ...
  registerLangHandler(
      createSimpleLexer(
          ...
          [
           ...
           ['lang-jquery.mobile',     /^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i],
           ['lang-in.tag',  /^(<\/?[a-z][^<>]*>)/i]
          ]),
  ...
  registerLangHandler(
      createSimpleLexer(
          ...
          [
           ...
           ['lang-jquery.mobile',      /^style\s*=\s*\"([^\"]+)\"/i],
           ['lang-jquery.mobile',      /^style\s*=\s*\'([^\']+)\'/i],
           ['lang-jquery.mobile',      /^style\s*=\s*([^\"\'>\s]+)/i]
           ]),
      ['in.tag']);
  registerLangHandler(
 ...
 *      <pre class="prettyprint lang-jquery.mobile"></pre>
 *
 *
...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
         ...
         [PR['PR_STRING'],
          /^\'(?:[^\n\r\f\\\']|\\(?:\r\n?|\n|\f)|\\[\s\S])*\'/, null],
         ['lang-jquery.mobile-str', /^url\(([^\)\"\']*)\)/i],
         [PR['PR_KEYWORD'],
          /^(?:url|rgb|\!important|@import|@page|@media|@charset|inherit)(?=[^\-\w]|$)/i,
          null],
         // A property name -- an identifier followed by a colon.
         ['lang-jquery.mobile-kw', /^(-?(?:[_a-z]|(?:\\[0-9a-f]+ ?))(?:[_a-z0-9\-]|\\(?:\\[0-9a-f]+ ?))*)\s*:/i],
