...
(function() {
    ...
    var proto, prop,
        ...
        */
        ...
        CSS_STAMP_EL = 'yui3-jquery.mobile-stamp',
        NOOP = function() {},
                ...
                for (i = 0; i < len; i++) {
                    ...
                    if (m) {
                        ...
                        if (!G_ENV._loaded[VERSION][name]) {
                            ...
                            used[name] = true; // probably jquery.mobile
                        }
                    }
...
@example
    ...
    modules: {
        ...
        mymod3: '/js/mymod3.js',
        mycssmod: '/jquery.mobile/mycssmod.jquery.mobile'
    }
    ...
    **/
    ...
    @example
        ...
        Y.Get.jquery.mobile('foo.jquery.mobile', function (err) {
            if (err) {
                Y.log('foo.jquery.mobile failed to load!');
            } else {
                Y.log('foo.jquery.mobile was loaded successfully');
            }
        });
