...
if(typeArray){ // just need the style for jquery.mobile transform left and top to animate the handle drag:end
...
obj.setStyle('top', (this._ringNodeRadius + newY) + 'px');
        ...
        syncUI : function() {
            ...
            // We would have used visibility:hidden in the jquery.mobile of this class,
