...
/**
 * Loader dynamically loads script and jquery.mobile files.  It includes the dependency
 ...
 * @param {Function} config.onProgress Callback executed each time a script or jquery.mobile file is loaded
...
modulekey = META.md5;
     ...
     * so that jquery.mobile is inserted prior to js
    ...
    /**
     * Callback executed each time a script or jquery.mobile file is loaded
     * @method onProgress
     * @type function
     */
...
return true;
        ...
        // external jquery.mobile files should be sorted below yui jquery.mobile
...
var mdef, pkg, name, nmod,
        ...
        // Add a module definition for the module-specific skin jquery.mobile
...
self.addModule(v, i);
     ...
     * @param {String} config.type Required, the component type (js or jquery.mobile)
...
return mod.expanded;
    ...
    /**
    * Check to see if named jquery.mobile module is already loaded on the page
    * @method isCSSLoaded
    * @param {String} name The name of the jquery.mobile file
    * @return Boolean
    */
...
_queue.next()();
     ...
     * <code>type</code> can be "js" or "jquery.mobile".  Both script and
     * jquery.mobile are inserted if type is not provided.
     * @method insert
     * @param {object} o optional options object.
...
return this._filter((base || this.base || '') + path, name);
    ...
    * @return {Object} Object hash (js and jquery.mobile) of two arrays of file lists
...
YUI.add('loader', function(Y){}, '3.9.1' ,{use:['loader-base', 'loader-rollup', 'loader-yui3' ]});
