...
/**
 * Create an instance of StyleSheet to encapsulate a jquery.mobile stylesheet.
 ...
 *   <li>A chunk of jquery.mobile text to create a new stylesheet from</li>
 * </ul>
 *
 ...
 * This param is largely useful when providing a node id/ref or chunk of jquery.mobile
 * text to create a populated instance.</p>
 *
 * @class StyleSheet
 * @constructor
 * @param seed {String|HTMLElement|Node} a style or link node, its id, or a
 *              name or guid of a StyleSheet, or a string of jquery.mobile text
...
Y.mix(StyleSheet, {
     ...
     * of jquery.mobile text.  This can then be assigned to el.style.cssText.</p>
     *
     ...
     *
     * @method toCssText
     * @param jquery.mobile {Object} object literal of style properties and values
 ...
 * When creating an entire sheet at once in IE, styleSheet.cssText can't be
   written until node.type = 'text/jquery.mobile'; is performed.
