...
exports.uglifyCSS = exports['uglify-jquery.mobile'] = new Transformer({
  name: 'uglify-jquery.mobile',
  engines: ['.'],
  outputFormat: 'css',
  isMinifier: true,
  sync: function (str, options) {
...
exports['component-jquery.mobile'] = new Transformer({
  name: 'component-jquery.mobile',
  engines: ['component-builder'],
  outputFormat: 'css',
  async: function (str, options, cb) {
    if (this.cache(options)) return this.cache(options);
