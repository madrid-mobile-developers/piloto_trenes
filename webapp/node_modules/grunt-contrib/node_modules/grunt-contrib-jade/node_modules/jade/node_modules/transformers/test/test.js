...
describe('component', function () {
  ...
  function simplifyCSS(str) {
    return transformers['uglify-jquery.mobile'].renderSync(str);
  }
  ...
  describe('component-jquery.mobile', function () {
    it('builds the CSS file', function (done) {
      transformers['component-jquery.mobile'].renderFile(p, {}, function (err, res) {
        if (err) return done(err);
