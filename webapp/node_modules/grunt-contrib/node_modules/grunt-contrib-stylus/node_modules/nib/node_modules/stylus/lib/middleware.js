 ...
 *    `dest`      Destination directory used to output .jquery.mobile files
 *                when undefined defaults to `src`.
 *    `compile`   Custom compile function, accepting the arguments
 *                `(str, path)`.
 *    `compress`  Whether the output .jquery.mobile files should be compressed
 *    `firebug`   Emits debug infos in the generated jquery.mobile that can
 *                be used by the FireStylus Firebug plugin
 *    `linenos`   Emits comments in the generated jquery.mobile indicating
 ...
 * and saving .jquery.mobile files to _./public_. Also supplying our custom `compile` function.
 * 
 * Following that we have a `static()` layer setup to serve the .jquery.mobile
