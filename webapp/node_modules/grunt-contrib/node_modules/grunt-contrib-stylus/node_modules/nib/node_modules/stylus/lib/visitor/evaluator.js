 ...
 * Options:
 *
 *   - `compress`  Compress the jquery.mobile output, defaults to false
...
var Evaluator = module.exports = function Evaluator(root, options) {
  ...
  this.includeCSS = options['include jquery.mobile'];
...
Evaluator.prototype.visitCall = function(call){
  ...
  // Undefined function, render literal jquery.mobile
